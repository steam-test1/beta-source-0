...
function NodeGui:init( node, layer, parameters )
	...
	self.row_item_color				= Color( 1, 141/255, 176/255, 211/255 )
	self.row_item_hightlight_color	= Color( 1, 141/255, 176/255, 211/255 )
...
function NodeGui:_highlight_row_item( row_item, mouse_over )
	if row_item then		
		row_item.color = row_item_hightlight_color or self.row_item_hightlight_color -- Color( 1, 1, 1, 1 )
