...
function CoreDebugUnitElement:_build_panel( panel, panel_sizer )
	...
	debug:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = debug, value = "debug_string" } )
	debug:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = debug, value = "debug_string" } )
end
