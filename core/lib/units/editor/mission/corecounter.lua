...
function CoreCounterUnitElement:_build_panel( panel, panel_sizer )
	...
	counter_target:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = counter_target, value = "counter_target" } )
	counter_target:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = counter_target, value = "counter_target" } )
end
...
function CoreCounterOperatorUnitElement:_build_panel( panel, panel_sizer )
	...
	local operation_params = {
		...
		sizer 				= panel_sizer,
		default				= "none",
		options				= { "add", "subtract", "reset", "set" },
...
function CoreCounterTriggerUnitElement:_build_panel( panel, panel_sizer )
	...
	local trigger_type_params = {
		...
		sizer 				= panel_sizer,
		default				= "none",
		options				= { "value", "add", "subtract", "reset", "set" },
...
function CoreCounterFilterUnitElement:_build_panel( panel, panel_sizer )
	...
	needed_to_execute:connect( "EVT_COMMAND_COMBOBOX_SELECTED", callback( self, self, "set_element_data" ), { ctrlr = needed_to_execute, value = "needed_to_execute" } )
	...
	local check_type_params = {
		...
		panel 				= panel,
		sizer 				= panel_sizer,
		options				= { "equal", "less_than", "greater_than", "less_or_equal", "greater_or_equal", "counters_equal" },
