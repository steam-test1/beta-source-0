...
function CoreToggleUnitElement:_build_panel( panel, panel_sizer )
	...
	set_trigger_times:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = set_trigger_times, value = "set_trigger_times" } )
	set_trigger_times:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = set_trigger_times, value = "set_trigger_times" } )
end
