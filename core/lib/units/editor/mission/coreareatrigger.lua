...
function CoreAreaTriggerUnitElement:add_element()
	...
	if ray and ray.unit and string.find( ray.unit:name():s(), "point_spawn_unit", 1 ,true ) then -- ray.unit:name() == "me_spawn_unit" then
...
function CoreAreaTriggerUnitElement:update_selected( t, dt )
	...
	elseif self._hed.shape_type == "cylinder" then
